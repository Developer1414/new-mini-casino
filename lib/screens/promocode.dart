...
class Promocode extends StatefulWidget {
  const Promocode({super.key, this.initPromocode = ''});

  final String initPromocode;
...
class _PromocodeState extends State<Promocode> {
  ...
  Widget build(BuildContext context) {
    Promocode.promocodeController = TextEditingController(
        text: widget.initPromocode != ' '
            ? widget.initPromocode
