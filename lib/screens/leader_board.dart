...
class _LeaderBoardState extends State<LeaderBoard> {
  static bool isSearchUser = false;
          ...
          body: isSearchUser
              ? StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return list(snapshot: snapshot, isShowRaiting: false);
                  })
              : StreamBuilder(
                  stream: FirebaseFirestore.instance
                      .collection('users')
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            margin: EdgeInsets.only(
                left: 15.0,
                right: 15.0,
                bottom: index + 1 == snapshot.data?.docs.length ? 15.0 : 0.0),
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(15.0),
                color: Colors.white,
                border: (index + 1) == 1 || (index + 1) == 2 || (index + 1) == 3
